...
Instead, it follows a **structured, multi-phase process** that includes:
...
game.js
```
The system then automatically saves runnable files that work locally in a browser.

This project is not a prompt-engineering exercise.
It is a structured AI system designed with clear phases and responsibilities, packaged inside Docker for reproducibility and evaluation.
...
Without this file, the system cannot run.
...
This ensures requirements are clear before moving forward.
...
This phase ensures the system thinks before building.
...
If the format is incorrect, the process stops.
...
Separating this layer keeps the architecture clean and allows easy model replacement.
...
→ Prioritized agent structure and workflow
